 ...
 *
 * A public install can end up with `origin=git@github.com:KNT-AJ/hermes-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/KNT-AJ/hermes-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/knt-aj/hermes-agent'
