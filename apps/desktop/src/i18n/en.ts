...
export const en: Translations = {
  ...
  boot: {
    ready: 'dragonfly is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading dragonfly settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting dragonfly…'
    },
    errors: {
      backgroundExited: 'dragonfly background process exited.',
      backgroundExitedDuringStartup: 'dragonfly background process exited during startup.',
    ...
    failure: {
      title: "dragonfly couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update dragonfly',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting dragonfly.',
    ...
    native: {
      ...
      inputBody: 'dragonfly is waiting for your response.',
      turnDoneTitle: 'dragonfly finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to dragonfly defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while dragonfly is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'dragonfly asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while dragonfly was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let dragonfly follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what dragonfly is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen dragonfly, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'dragonfly checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading dragonfly configuration...',
    ...
    gateway: {
      ...
      intro:
        'dragonfly starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'dragonfly will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Backend ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. dragonfly runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  starmap: {
    ...
    emptyDesc: 'As dragonfly builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart dragonfly to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update dragonfly to generate pets.',
      backgroundHint: 'You can close this — dragonfly will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure dragonfly' },
    ...
    hermesActiveSessions: (version, count) => `dragonfly ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent dragonfly environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. dragonfly will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from dragonfly. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting dragonfly...',
    placeholderReconnecting: 'Reconnecting to dragonfly…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give dragonfly a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'dragonfly will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask dragonfly to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating dragonfly…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting dragonfly…',
    ...
    unsupportedMessage: 'This version of dragonfly can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of dragonfly is ready to install.',
    ...
    manualBody: 'You installed dragonfly from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'dragonfly will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the dragonfly desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The dragonfly updater takes over in its own window and reopens dragonfly automatically when it’s done. Please don’t reopen dragonfly yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. dragonfly reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then dragonfly reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'dragonfly needs a one-time install',
    ...
    settingUpTitle: 'Setting up dragonfly',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another dragonfly CLI or desktop instance is running. Stop any running dragonfly instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The dragonfly installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you set up with dragonfly",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'dragonfly is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting dragonfly…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run dragonfly',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point dragonfly at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — dragonfly connects automatically',
    ...
    authorizeThere: 'Authorize dragonfly there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize dragonfly there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `dragonfly v${version}`,
      ...
      gatewayTitle: 'dragonfly inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. dragonfly will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'dragonfly is restarting...',
      askRestart: 'Ask dragonfly to restart the server',
      lookingRestart: taskId => `dragonfly is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'dragonfly is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `dragonfly finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'dragonfly could not restart the server.',
      stillWorking:
        'dragonfly is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'dragonfly is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'dragonfly gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). dragonfly won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'dragonfly needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'dragonfly needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart dragonfly to use Save Image.',
    restartToSaveImages: 'Restart dragonfly to save images',
